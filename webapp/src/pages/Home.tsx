...
const features = [
  {
    ...
    screenshot: "/screenshots/guardian.png",
        ...
        <div className={cn(isReversed ? "lg:order-2" : "lg:order-1")}>
          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover object-top opacity-90 transition-opacity duration-500 hover:opacity-100"
              onError={(e) => {
            ...
            {/* Fallback Icon + label centered (hidden if image loads) */}
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 hidden">
              <div
